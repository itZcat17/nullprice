...
- automatically detected system dependencies such as .NET runtimes/SDKs, ASP.NET,
  Visual C++ redistributables, Node.js, Python, and Java inventory;
...
Components without a safe automatic package are listed as a warning for manual installation.
